...
const IGNORED_FOR_COMPARISON = new Set<keyof RouteProperties>([
  "id",
  "groupId",
  "stageId",
  "sources",
...
export function isPartOfSameRoute(
  left: RouteFeature,
  right: RouteFeature,
): boolean {
...
function propertiesEqualForJoining(
  ...
  const leftKeys = Object.keys(left) as (keyof RouteProperties)[];
...
export function mergedRouteProperties(
  allProperties: RouteProperties[],
): RouteProperties {
